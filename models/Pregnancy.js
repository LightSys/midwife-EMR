...
CREATE TABLE `pregnancy` (
  ...
  `transferOfCare` datetime DEFAULT NULL,
  `transferOfCareNote` varchar(1000) DEFAULT '',
...
Pregnancy = Bookshelf.Model.extend({
  ...
  , permittedAttributes: ['id', 'firstname', 'lastname', 'maidenname', 'nickname',
      ...
      'transferOfCare', 'transferOfCareNote', 'currentlyVomiting',
  ...
  , pregnote: function() {
      return this.hasMany(require('./Pregnote').Pregnote, 'pregnancy_id');
    }
