...
CREATE TABLE `newbornExam` (
  ...
  `appearanceComment` varchar(500) DEFAULT NULL,
  `color` varchar(500) DEFAULT NULL,
  `colorComment` varchar(500) DEFAULT NULL,
  `skin` varchar(500) DEFAULT NULL,
  `skinComment` varchar(500) DEFAULT NULL,
  `head` varchar(500) DEFAULT NULL,
  `headComment` varchar(500) DEFAULT NULL,
  `eyes` varchar(500) DEFAULT NULL,
  `eyesComment` varchar(500) DEFAULT NULL,
  `ears` varchar(500) DEFAULT NULL,
  `earsComment` varchar(500) DEFAULT NULL,
  `nose` varchar(500) DEFAULT NULL,
  `noseComment` varchar(500) DEFAULT NULL,
  `mouth` varchar(500) DEFAULT NULL,
  `mouthComment` varchar(500) DEFAULT NULL,
  `neck` varchar(500) DEFAULT NULL,
  `neckComment` varchar(500) DEFAULT NULL,
  `chest` varchar(500) DEFAULT NULL,
  `chestComment` varchar(500) DEFAULT NULL,
  `lungs` varchar(500) DEFAULT NULL,
  `lungsComment` varchar(500) DEFAULT NULL,
  `heart` varchar(500) DEFAULT NULL,
  `heartComment` varchar(500) DEFAULT NULL,
  `abdomen` varchar(500) DEFAULT NULL,
  `abdomenComment` varchar(500) DEFAULT NULL,
  `hips` varchar(500) DEFAULT NULL,
  `hipsComment` varchar(500) DEFAULT NULL,
  `cord` varchar(500) DEFAULT NULL,
  `cordComment` varchar(500) DEFAULT NULL,
  `femoralPulses` varchar(500) DEFAULT NULL,
  `femoralPulsesComment` varchar(500) DEFAULT NULL,
  `genitalia` varchar(500) DEFAULT NULL,
  `genitaliaComment` varchar(500) DEFAULT NULL,
  `anus` varchar(500) DEFAULT NULL,
  `anusComment` varchar(500) DEFAULT NULL,
  `back` varchar(500) DEFAULT NULL,
  `backComment` varchar(500) DEFAULT NULL,
  `extremities` varchar(500) DEFAULT NULL,
  `extremitiesComment` varchar(500) DEFAULT NULL,
...
NewbornExam = Bookshelf.Model.extend({
  ...
  , permittedAttributes: ['id', 'examDatetime', 'examiners', 'rr', 'hr',
    'temperature', 'length', 'headCir', 'chestCir', 'appearance', 'appearanceComment',
    'color', 'colorComment', 'skin', 'skinComment', 'head', 'headComment', 'eyes',
    'eyesComment', 'ears', 'earsComment', 'nose', 'noseComment', 'mouth',
    'mouthComment', 'neck', 'neckComment', 'chest', 'chestComment', 'lungs',
    'lungsComment', 'heart', 'heartComment', 'abdomen', 'abdomenComment', 'hips',
    'hipsComment', 'cord', 'cordComment', 'femoralPulses', 'femoralPulsesComment',
    'genitalia', 'genitaliaComment', 'anus', 'anusComment', 'back', 'backComment',
    'extremities', 'extremitiesComment', 'estGA', 'moroReflex', 'moroReflexComment',
