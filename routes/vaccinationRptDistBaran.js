...
var run = function(req, res) {
  ...
  if (! fieldsReady) {
    logWarn('Vaccination report: not all fields supplied.');
  ...
  writable.on('finish', function() {
    fs.stat(filePath, function(err, stats) {
      ...
      var size = stats.size;
      var downloadFilename = generateReportFilename('VaccinationRpt_DistBarangay', 'pdf');
      ...
      switch (reportFormat) {
        case FORMAT_SCREEN:
          res.setHeader('Content-Disposition', 'inline; VaccinationRpt_DistBarangay.pdf');
