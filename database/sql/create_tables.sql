...
CREATE TABLE IF NOT EXISTS `discharge` (
  ...
  transferBaby BOOLEAN NULL DEFAULT 0,
  transferMother BOOLEAN NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `birthCertificate` (
  ...
  receivedByTitle VARCHAR(100) NULL,
  affiateName VARCHAR(100) NULL,
  affiateAddress VARCHAR(200) NULL,
  affiateCitizenshipCountry VARCHAR(100) NULL,
  affiateReason VARCHAR(200) NULL,
  affiateIAm VARCHAR(100) NULL,
  affiateCommTaxNumber VARCHAR(50) NULL,
  affiateCommTaxDate DATE NULL,
  affiateCommTaxPlace VARCHAR(50),
  comments VARCHAR(300) NULL,
  updatedBy INT NOT NULL,
  updatedAt DATETIME NOT NULL,
  supervisor INT NULL,
