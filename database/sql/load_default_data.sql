...
INSERT INTO `labTest`
  (name, abbrev, normal, unit, minRangeDecimal, maxRangeDecimal,
   minRangeInteger, maxRangeInteger, labSuite_id, updatedBy, updatedAt)
VALUES
  -- Blood
  ('Hematocrit', 'Hct', '30-40', '%', NULL, NULL, 0, 60,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  ('Hemoglobin', 'Hgb', '100-140', 'g/L', NULL, NULL, 0, 170,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  ('Hepatitis B Surface Antigen', 'HBsAg', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  ('Blood Type', 'Blood type', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  ('RPR', 'RPR', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  ('VDRL', 'VDRL', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Blood'), 1, NOW()),
  -- Urinalysis
  ('Albumin/Protein', 'Albumin/Protein', NULL, 'mg/dL', NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Sugar/Glucose', 'Sugar/Glucose', NULL, 'mg/dL', NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Epithelial Cells-Urine', 'Epithelial Cells-Urine', '0-5', 'hpf', NULL, NULL, 0, 1000,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('White Blood Cells', 'wbc', '0-4', 'hpf', NULL, NULL, 0, 1000,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Red Blood Cells', 'rbc-urine', NULL, 'hpf', NULL, NULL, 0, 1000,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Bacteria', 'Bacteria', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Mucous', 'Mucous', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Trichomonas-Urine', 'Trichomonas-Urine', '0', 'hpf', NULL, NULL, 0, 1000,
    (SELECT id FROM labSuite WHERE name = 'Urinalysis'), 1, NOW()),
  ('Trichomonas-WetMount', 'Trichomonas-WetMount', '0', 'hpf', NULL, NULL, 0, 1000,
    (SELECT id FROM labSuite WHERE name = 'Wet mount'), 1, NOW()),
  ('Yeast-Urine', 'Yeast-Urine', NULL, 'hpf', NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Wet mount'), 1, NOW()),
  ('Clue Cells', 'Clue Cells', NULL, 'hpf', NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Wet mount'), 1, NOW()),
  -- Gram stain
  ('Red Blood Cells-Gram', 'rbc-Gram', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Leukocytes', 'Leukocytes', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Epithelial Cells-Gram', 'Epithelial Cells-Gram', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram negative (-) cocci', 'Gram negative (-) cocci', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram positive (+) cocci', 'Gram positive (+) cocci', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram negative (-) coccobacilli', 'Gram negative (-) coccobacilli', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram positive (+) cocci in pairs', 'Gram positive (+) cocci in pairs', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram negative (-) bacilli', 'Gram negative (-) bacilli', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram positive (+) bacilli', 'Gram positive (+) bacilli', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram negative (-) extracellular diplococci', 'Gram negative (-) extracellular diplococci', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Gram negative (-) intracellular diplococci', 'Gram negative (-) intracellular diplococci', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Yeast-Gram', 'Yeast-Gram', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Fungi', 'Fungi', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Trichomonads', 'Trichomonads', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW()),
  ('Sperm Cells', 'Sperm Cells', NULL, NULL, NULL, NULL, NULL, NULL,
    (SELECT id FROM labSuite WHERE name = 'Gram stain'), 1, NOW())
;
