...
ALTER TABLE userLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE roleLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE user_roleLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE patientLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE vaccinationTypeLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE vaccinationLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE pregnancyLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE personInfoLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE partnerLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE healthTeachingLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE medicationTypeLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE medicationLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE pregnancyQuestionnaireLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE pregnancyHistoryLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE prenatalExamLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE labTestLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE labResultLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
...
ALTER TABLE referralLog ADD COLUMN replacedAt TIMESTAMP(6) DEFAULT NOW();
